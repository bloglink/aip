...
public:
    ...
    void Pub_PWR_Param(QStringList, int *waveform_point);
...
private:
    ...
    QStringList TaskMagDirstrList[2]; // -反嵌测试列表
    ...
    QStringList IR_ACW_Error;         // -相间绝缘耐压异常错误
    ...
    int  PG_Low;
    bool  Hall_A_ing;
    bool  Ready_Stop_NOLOAD; bool  NOload_Up_Finsh;
    bool  Ready_Stop_BEMF;   bool  BEMF_Up_Finsh;
    bool  Ready_Stop_LOAD;   bool  LOAD_Up_Finsh;
    ...
    QStringList Bemf_Update;
    QStringList Load_Update;
    bool Start_No;
    ...
    void Test_WMessage(QString Waring_Text);
    ...
    void PG_Param(QStringList, int *waveform_point);
    ...
    void join_test_start_one();
    void join_test_start_two(QStringList);
...
signals:
    ...
    void Signal_test_to_Switchover(int, int, int);
...
private slots:
    ...
    void join_test_LLLoad();
    void join_test_noload();
    void join_test_lold();
    void join_test_hall();
    void join_test_bemf();
